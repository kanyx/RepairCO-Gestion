Module variables_globales
    ...
    Public _globalClientes As ArrayList ' # ARREGLO QUE CONTIENE LA INFORMACION DE LOS CLIENTES PARA DESPLEGAR EN LOS FORMULARIOS.
    ...
    Public _globalModelos As ArrayList ' # ARREGLO QUE CONTIENE TODOS LOS MODELOS DE LAS MARCAS (CARGA DE LA BASE DE DATOS)
