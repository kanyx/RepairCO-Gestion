...
#Region "Code 128"
    ...
    End Enum
    Public Shared Function Code128(ByVal _code As String, Optional ByVal codeType As Integer = Code128SubTypes.CODE128, Optional ByVal PrintTextInCode As Boolean = False, Optional ByVal Height As Single = 0, Optional ByVal GenerateChecksum As Boolean = True, Optional ByVal ChecksumText As Boolean = True) As Bitmap
        If _code.Trim = "" Then
            Return Nothing
        Else
...
#Region "DataMatrix (2d)"
    Public Shared Function DataMatrix(ByVal _code As String, Optional ByVal Scale As Integer = 1) As Bitmap
        If _code.Trim = "" Then
            Return Nothing
        Else
...
#Region "PDF417 (2d)"
    Public Shared Function PDF417(ByVal _code As String, Optional ByVal Scale As Integer = 1) As Bitmap
        If _code.Trim = "" Then
            Return Nothing
        Else
